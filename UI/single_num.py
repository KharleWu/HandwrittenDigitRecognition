...
class sin_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "单个数字识别"))

        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">使用说明</span></p><p><span style=\" font-size:12pt;\">1、根据所需功能选择模式</span></p><p><span style=\" font-size:12pt;\">2、选择想要使用的算法</span></p><p><span style=\" font-size:12pt;\">3、输入待识别数据后，点击“识别”，得到识别结果和Softmax值</span></p><p><span style=\" font-size:12pt;\">4、点击“清除数据”后可重新输入待识别数据</span></p></body></html>"))
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "MINIST随机抽取"))
        self.comboBox.setItemText(2, _translate("MainWindow", "鼠标手写输入"))
        self.comboBox.setItemText(3, _translate("MainWindow", "上传本地图片"))
        ...
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">置信度</span></p></body></html>"))
        ...
        self.pbtGetMnist.setText(_translate("MainWindow", "MINIST随机抽取"))
